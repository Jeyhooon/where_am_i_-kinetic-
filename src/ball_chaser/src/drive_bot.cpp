...
// global publisher motor commands
...
{
    ROS_INFO("DriveToTargetRequest received - linear_velocity_x:%1.2f, angular_velocity_z:%1.2f", (float)req.linear_x, (float)req.angular_z);
    ...
    res.msg_feedback = "cmd_vel set - linear_x: " + std::to_string(req.linear_x) +
